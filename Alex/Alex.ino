...
//need do define after doing manual measurements
...
//vincent's diagonal
//computer and store once, since expensive to compute and doesnt really change
float vincentDiagonal = 0.0;

//vincent's turning circumference, calc once
...
void sendStatus()
{
  ...
  statusPacket.params[3] = rigthReverseTicks;
...
//New function to estimate no. of wheel ticks
//needed to turn at an angle
unsigned long computeDeltaTicks(float ang){
  //assume angular distance moved = linear distance moved in one wheel revolution
  //this is (probably) incorrect but simplifies calculation
  //# of wheel revs to make one full turn is vincentCirc / WHEEL_CIRC
  //this is for 360 deg.
  //for ang degrees it will be (ang*vincentCirc) / (360 * WHEEL_CIRC)
